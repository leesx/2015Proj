...
$(document).ready(
	function() 
	{
		$(".menuTitle").click(function(){
			...
			$("#qiehuan").toggleClass("menu-left-down");			
			$("#qiehuan").siblings(".menu-left").removeClass("menu-left-down");
...
$(document).ready(
	function() 
	{
		$(".menuTitle1").click(function(){
			$(this).next("div").slideToggle("slow")
			.siblings(".menuContent:visible").slideUp("slow");
			$("#qiehuan1").toggleClass("menu-left-down");			
			$("#qiehuan1").siblings(".menu-left").removeClass("menu-left-down");
...
$(document).ready(
	function() 
	{
		$(".menuTitle2").click(function(){
			$(this).next("div").slideToggle("slow")
			.siblings(".menuContent:visible").slideUp("slow");
			$("#qiehuan2").toggleClass("menu-left-down");			
			$("#qiehuan2").siblings(".menu-left").removeClass("menu-left-down");
...
$(document).ready(
	function() 
	{
		$(".menuTitle3").click(function(){
			$(this).next("div").slideToggle("slow")
			.siblings(".menuContent:visible").slideUp("slow");
			$("#qiehuan3").toggleClass("menu-left-down");			
			$("#qiehuan3").siblings(".menu-left").removeClass("menu-left-down");
...
$(document).ready(
	function() 
	{
		$(".menuTitle4").click(function(){
			$(this).next("div").slideToggle("slow")
			.siblings(".menuContent:visible").slideUp("slow");
			$("#qiehuan4").toggleClass("menu-left-down");			
			$("#qiehuan4").siblings(".menu-left").removeClass("menu-left-down");
...
$(document).ready(
	function() 
	{
		$(".menuTitle5").click(function(){
			$(this).next("div").slideToggle("slow")
			.siblings(".menuContent:visible").slideUp("slow");
			$("#qiehuan5").toggleClass("menu-left-down");			
			$("#qiehuan5").siblings(".menu-left").removeClass("menu-left-down");
